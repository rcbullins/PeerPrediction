function [] = PP_OptimalWindow_ScatterPlot(min_win,dev,devControl, y_plot_limit,winRange)
...
for ipair = 1:num_pairs
    idx_dev = (winRange == min_win(ipair)); %min_win gives the window of where the minimum deviance is
